...
- Name: auth-flows.spec.ts >> P0/P1 Fix - Auth Flows >> 38 - Health check endpoint
- Location: tests\auth-flows.spec.ts:101:7

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:3000/api/health
Call log:
