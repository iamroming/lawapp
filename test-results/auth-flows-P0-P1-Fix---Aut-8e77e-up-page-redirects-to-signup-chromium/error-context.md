...
- Name: auth-flows.spec.ts >> P0/P1 Fix - Auth Flows >> 33 - Setup page redirects to signup
- Location: tests\auth-flows.spec.ts:37:7

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:3000/setup
Call log:
  - navigating to "http://localhost:3000/setup", waiting until "load"
