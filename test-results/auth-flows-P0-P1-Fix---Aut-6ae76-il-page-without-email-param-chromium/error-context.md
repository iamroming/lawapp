...
- Name: auth-flows.spec.ts >> P0/P1 Fix - Auth Flows >> 31 - Confirm email page without email param
- Location: tests\auth-flows.spec.ts:17:7

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:3000/confirm-email
Call log:
  - navigating to "http://localhost:3000/confirm-email", waiting until "load"
