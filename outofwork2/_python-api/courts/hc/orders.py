"""Vercel serverless function - HC Orders."""
import json
...
class handler(BaseHTTPRequestHandler):
    ...
    async def _handle(self):
        try:
            ...
            case_type = params.get("case_type", [None])[0]
            case_number = params.get("case_number", [None])[0]
            ...
            async with HCServicesClient(captcha_solver=solver) as client:
                ...
                self._json_response([o.to_dict(exclude_none=True) for o in orders])
