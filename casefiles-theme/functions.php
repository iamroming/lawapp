...
function casefiles_get_fallback_plans() {
    return array(
        ...
        array(
            ...
            'max_users'     => 2,
            'max_storage_mb'=> 1024,
            'features'      => array( '50 active cases', '2 users', '1 GB storage', 'Court calendar sync', 'GST invoicing', '100 AI queries/month', 'WhatsApp reminders' ),
        ...
        array(
            ...
            'max_users'     => 5,
            'max_storage_mb'=> 5120,
            'features'      => array( '150 active cases', '5 users included', '5 GB storage', 'AI research & drafting', 'Full client portal', 'GST invoicing', 'E-filing integration', 'Priority support' ),
            'cta_text'      => 'Start 14-Day Trial',
            'cta_url'       => '#',
            'highlighted'   => true,
            'badge'         => 'Most Popular',
        ...
        array(
            ...
            'features'      => array( '350 active cases', '20 users included', '20 GB storage', 'Admin controls', 'Custom reports', 'Audit logging', 'Custom branding', 'Dedicated support', '2000 AI queries/month' ),
            'cta_text'      => 'Start 14-Day Trial',
            'cta_url'       => '#',
            'highlighted'   => false,
        ),
        array(
            ...
            'max_users'     => -1,
            'max_storage_mb'=> -1,
            'features'      => array( 'Unlimited cases', 'Unlimited users', 'Unlimited storage', 'Everything in Firm', '5000 AI queries/month', 'Dedicated support', 'Custom integrations', 'SLA guarantee' ),
