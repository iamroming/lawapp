...
function casefiles_get_fallback_plans() {
    return array(
        ...
        array(
            ...
            'features'      => array( 'Unlimited cases', '5 users included', '10 GB storage', 'AI research & drafting', 'Full client portal', 'GST invoicing', 'E-filing integration', 'Priority support' ),
            'cta_text'      => 'Start 14-Day Trial',
            'cta_url'       => '#',
            'highlighted'   => true,
            'badge'         => 'Most Popular',
        ...
        array(
            ...
            'features'      => array( 'Unlimited cases', '20 users included', '50 GB storage', 'Admin controls', 'Custom reports', 'Audit logging', 'Custom branding', 'Dedicated support' ),
            'cta_text'      => 'Start 14-Day Trial',
            'cta_url'       => '#',
            'highlighted'   => false,
        ),
