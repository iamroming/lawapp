...
export const PLANS = {
  ...
  solo: {
    name: "Solo",
    monthly: { price: 399, razorpayPlanId: process.env.RAZORPAY_PLAN_SOLO_MONTHLY || "" },
    annual: { price: 3999, razorpayPlanId: process.env.RAZORPAY_PLAN_SOLO_ANNUAL || "" },
    max_cases: 50,
    max_users: 2,
    max_storage_mb: 1024,
    max_ai_queries: 100,
  ...
  professional: {
    name: "Professional",
    monthly: { price: 899, razorpayPlanId: process.env.RAZORPAY_PLAN_PROFESSIONAL_MONTHLY || "" },
    annual: { price: 8999, razorpayPlanId: process.env.RAZORPAY_PLAN_PROFESSIONAL_ANNUAL || "" },
    max_cases: 150,
    max_users: 5,
    max_storage_mb: 5120,
    max_ai_queries: 300,
